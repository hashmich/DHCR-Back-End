...
<div class="users_form">
	...
	if(empty($shibUser)){
		...
		if(!empty($this->Session->read('Users.verification'))) { ?>
		    ...
		    <fieldset>
        		<p>
                    If you are lecturer or member of an academic institution in the
                    field of digital humanities,
                    please register here. After approval of a moderator,
                    you can add courses to the registry.
                </p>
            </fieldset>
		<?php } ?>

	<?php }else{ ?>
		<h2>User Information Completion</h2>
	<?php } ?>
	...
	echo $this->Form->input('university', array(
		...
		'type' => 'textarea',
		'placeholder' => 'If you cannot find your institution in the dropdown list above,
		    please provide country, city and name of your institution.'
	));
    ...
    if(empty($shibUser))
        echo $this->Form->input('about', array(
            'type' => 'textarea',
            'placeholder' => 'Please provide some details about who you are and your
                institutional occupation, so that our moderators get an idea of your
                involvement into Digital Humanities.',
        ));

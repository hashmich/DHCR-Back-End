...
<div class="accordeon-item">
    <h3><span>Source-URL and Lecturer Contact</span></h3>
    <div class="item-content">
        <fieldset>
            <p>
...
<div class="accordeon-item">
    <h3><span>Description and Access</span></h3>
    <div class="item-content">
        <fieldset>
...
<div class="accordeon-item">
    <h3><span>Start Date and Duration</span></h3>
    <div class="item-content">
        <fieldset>
            <p>
            ...
            <div class="input start_date required">
                ...
                echo $this->Form->input('recurring', ['type' => 'hidden']);
...
<div class="accordeon-item">
    <h3><span>Institution, Department and Geo-Location</span></h3>
    <div class="item-content">
        <fieldset>
            <?php
...
<div class="accordeon-item">
    <h3><span>Publish and Submit</span></h3>
    <div class="item-content">
        <fieldset>
            <p>
...
<?php
$this->Html->script(['modal','accordeon','start_date'], ['inline' => false]);
